...
float uPUR, uNIM, uCAMAC, uSIRI, uEVENT;     /*Extra delay until ADCs finished*/
...
int main() {                               /*Interrupt handler (Ctrl_C)       */
   ...
   printf("| Modified: 09-03-1998/ 12-06-1998/ 19-10-1998               |\r\n");
   printf("|____________________________________________________________|\r\n");
   printf("                                                              \r\n");
...
void Microsecond(){
   ...
   printf("NIM ADC Silena 7420    :  6 us at 2K, 12 us at 4K, 48 us at 8K \n");
