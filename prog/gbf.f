      ...
      WRITE(6,*)'    |                                             |'
      WRITE(6,*)'    |         GroundBandFeeding 1.3 (GBF)         |'
      WRITE(6,*)'    |                                             |'
...
c                       WRITE(6,41) Ex,ce1,ce2,e1,e2,FexpC(j),FexpG(j)
c 41            FORMAT(5F9.1,2F10.3)
      ENDDO
