 ...
 13   FORMAT('Mass number of the target nucleus <',I3,'>:',$)
      ...
      OPEN(10,ERR=98,FILE='/redux/osloware/programs/Data/masses.txt',STATUS='OLD')
 14   FORMAT(1X,I3,1X,I3,1X,F11.3)
      DO 15,i=1,2931
 ...
 15   CONTINUE
      CLOSE(10)
      WRITE(6,'(A50)')'File /redux/osloware/programs/Data/masses.txt read'
      WRITE(6,16)m1
 ...
 24      CONTINUE
     ...
     C      2.*m1*COS(l3)*SQRT(m2**2.-(m1*SIN(l3))**2.))
 25         FORMAT(F7.3,1X,E11.6,2X,E12.7)
