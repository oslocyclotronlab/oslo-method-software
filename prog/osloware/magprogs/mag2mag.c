/****************************************************************************
     ...
     *************************************************
     ...
     mag2mag /dev/rmt/0 /dev/rmt/1 (or whatever numbers suit)
...
=4x32kbytes.)
Program compiled for opal.nscl.msu.edu by Andreas Schiller
...
void t_help(int cond) {
   ...
   if (cond == 1) { /* illegal command line syntax */
     ...
     printf(" mag2mag /dev/rmt/0 /dev/rmt/1 (or whatever numbers suit)\n");
