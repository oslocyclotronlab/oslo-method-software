...
C *******DEFINITION OF TERMS
      ...
      CRIT3  =  (R24/R13)-(SIN(THETA))**2
      
      TCRIT  =  ASIN(SQRT(R24/R13))

       PHI1  = ASIN(SQRT(M3*E31/(M4*(ET-E31)))*SIN(THETA))
       PHI2  = ASIN(SQRT(M3*E32/(M4*(ET-E32)))*SIN(THETA))

      CRIT41 = SQRT( R23/R14-SIN(PHI1)**2)
      CRIT42 = SQRT( R23/R14-SIN(PHI2)**2)
...
C ********START OF LOGIC STRUCTURE
     ...
     *  PHI2      E42'
          ...
          DO WHILE(CRIT3.GT.0.0)
               ...
               E31   =ET*R13*(COS(THETA)+SQRT(CRIT3))**2
               PHI1  = ASIN(SQRT(M3*E31/(M4*(ET-E31)))*SIN(THETA))
               E41   =ET-E31
              CRIT41 = SQRT( R23/R14-SIN(PHI1)**2)
 
               E32   =ET*R13*(COS(THETA)-SQRT(CRIT3))**2
               PHI2  = ASIN(SQRT(M3*E32/(M4*(ET-E32)))*SIN(THETA))
               E42   =ET-E32
              CRIT42 = SQRT( R23/R14-SIN(PHI2)**2)
  ...
  25  FORMAT('     ',F6.3,'    ',F6.3,'    ',F6.3,'    ',F6.3,
     *'    ',F6.3,'    ',F6.3,'    ',F6.3)
              ...
              CRIT3  =  ((R24/R13)-(SIN(THETA))**2)
               ...
               E31   =ET*R13*(COS(THETA))**2
               PHI1  = ASIN(SQRT(M3*E31/(M4*(ET-E31)))*SIN(THETA))
               E41   =ET-E31
     
               E32   =ET*R13*(COS(THETA))**2
               PHI2  = ASIN(SQRT(M3*E32/(M4*(ET-E32)))*SIN(THETA))
               E42   =ET-E32
