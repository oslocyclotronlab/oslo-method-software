...
unsigned long for *pSUNSTATUS etc.
...
unsigned long *pBUFFER_ADDRESS, *pBUFFER_LENGTH, *pSEMA_1, *pSEMA_2;
unsigned long *pVMESTATUS, *pSUNSTATUS;
long il, header, p1;
...
int main() {                                      /*Interrupt handler (Ctrl_C)*/
   ...
   printf("| Modified: 09-03-1998/ 12-06-1998/ 11-12-1998               |\r\n");
   printf("|____________________________________________________________|\r\n");
   printf("                                                              \r\n");
