...
/* Modified 17 December  1998 by Magne Guttormsen (for RTPC)                  */
/* Present version: engine2.8                                                 */
#include    <stdio.h>
#include    <errno.h>
#include    <sys/file.h>
#include    <sys/types.h>
...
#define     WAIT2MS   2000                            /* Suspend time =  2 ms */
...
main()
{
   ...
   long      buffer1_address;       /* Data buffer 1 address (variable)       */
   long      buffer2_address;       /* Data buffer 2 address (variable)       */
   long      *sem1ptr;              /* Pointer to VME "semaphore" 1           */
   long      *sem2ptr;              /* Pointer to VME "semaphore" 2           */
   long      sem1val, sem2val;
   long      *engstatptr;
   long      engstatval;
   long      semph1, semph2, suns;
