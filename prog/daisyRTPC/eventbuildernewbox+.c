...
/* New untested things:
putting in various warnings for extremes
u_long for *pSUNSTATUS etc.
AM24 is set to 3d instead of 39
status, 3 swap1 to swap
change messagebox: semaphores ans status in A32
change u_char etc
*/
...
int main() {                                      /*Interrupt handler (Ctrl_C)*/
   ...
   printf("| Modified: 09-03-1998/ 12-06-1998/ 14-12-1998               |\r\n");
   printf("|____________________________________________________________|\r\n");
   printf("\r\n");
