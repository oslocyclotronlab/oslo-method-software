/* The communication program between RTPC VME acquisition computer and the */
/* Sun Sparcstation (lynx). The program fetches buffer 1 and 2 acording to */
/* semaphors given from the RTPC message box via the bit3 interface        */
/* Created  26 July      1994 by Tore Ramsoy      (for FIC)                */
/* Modified 10 September 1998 by Magne Guttormsen (for RTPC)               */
#include    <stdio.h>
#include    <errno.h>
#include    <sys/file.h>
#include    <sys/types.h>
