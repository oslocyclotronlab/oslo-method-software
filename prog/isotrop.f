...
C-- Defining Thetas in radians for NaI-detectors. Theta=180 dgr. is defined in
C   backward direction compared to the beam. Theta=0 dgr. is beam direction.
      angna(0,0) = 2.4887            
      angna(1,0) = 2.4887            
      angna(2,0) = 2.0345            
      angna(3,0) = 2.4887            
...
C   When looking beam towards Faraday-cup, Phi increases clockwise. 
      angna(0,1) = 5.6549           
      angna(1,1) = 0.6283           
      angna(2,1) = 2.5133           
      angna(3,1) = 3.1416        
...
C--   Incrementing the alfna matrix
          XrMAT(INT(par),ibeta)=XrMAT(INT(par),ibeta)+effnai
