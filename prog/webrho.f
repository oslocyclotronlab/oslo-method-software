 ...
 999  continue
      ...
      CLOSE(28)
      WRITE(6,18)idim2
 18   FORMAT('Number of excitation points  <',I4,'>:',$)
      CALL READI(5,idim2)
      GO TO 8888
 ...
 8888 FILNAM=UTFIL(1:LIN)//'.txt'
      ...
      DO i=1,idim2
         Ex=a0+a1*FLOAT(i-1)+a2*FLOAT(i-1)*FLOAT(i-1)
         WRITE(29,50)i,Ex,s(i),s(i+idim2)  
 50      FORMAT(I4,F11.3,'',2E15.3)
      ENDDO
      CLOSE(29)
      WRITE(6,*)'For convenience, you should rename the output file as rhopaw.tex or similar'
      END
