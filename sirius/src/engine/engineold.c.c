/* A communication program between RIO3 VME acquisition computer and the      		*/
/* main computer (tiger). The program fetches buffers  according to         		*/
/* semaphors given from the RIO3 message box via the SBS interface           		*/
...
/* Modified 22 April  	2008 (MG) RIO3 with Tiger and SBS VME-PCI bus interface		*/
/* Present version: engine1.0 Should by used with eventbuilder1.0 or higher  		*/
